...
def run():
    ...
    plot_expectation(t_eval, y_true, best_mldnn_mean, fem_mean, f"MLDNN (DNN, m={best_m})", f"fEM (N={n})", "Exact Analytic", "Exp 4: Fractional GBM", "exp4_fgbm.pdf")
    print(f"Saved exp4! Best m={best_m}\n")
