...
def run():
    ...
    plot_expectation(t_eval, y_true, mldnn_mean_best, fem_mean_best, f"MLELM ($\\hat{{m}}$ = {m_list[-1]})", f"fEM (N={n_list[-1]})", "Ground truth", "Example 4.3", "exp3_nonlinear_drift.pdf")
    plot_pareto(times_mldnn, err_mldnn, times_fem, err_fem, "exp3_pareto.pdf", labels_mldnn, labels_fem)
    print(f"Saved exp3!\n")
