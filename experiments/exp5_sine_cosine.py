...
def run():
    ...
    plot_expectation(t_eval, y_true, best_mldnn_mean, fem_mean, f"MLDNN (DNN, m={best_m})", f"fEM (N={n})", "Ground Truth", "Exp 5: Sine-Cosine", "exp5_sine_cosine.pdf")
    print(f"Saved exp5! Best m={best_m}\n")
