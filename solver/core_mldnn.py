...
*  Network / training: the architecture is L = 2 (fractional feature layer
   + linear output layer), N_theta(t) = c^T M(t).  The output weights are
   computed by the filtered frozen-coefficient multipass (FCMP) scheme in
   solver/fcmp.py; this module supplies the basis, operators and references.
...
# ============================================================================
# 4. Solution evaluation (the solver itself is solver/fcmp.py)
# ============================================================================

def evaluate_solution(alpha, mhat, c, t):
    """Evaluate N(t) = c^T M(t) at points t for M_j-basis coefficients c."""
    return basis_eval(alpha, mhat, np.asarray(t, float)).T @ np.asarray(c, float)

# ============================================================================
# 5. Fractional Euler-Maruyama reference scheme
# ============================================================================
